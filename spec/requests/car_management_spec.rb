...
describe 'Car management' do
  context 'index' do
    it 'renders available cars' do
      ...
      subsidiary1 = create(:subsidiary, cnpj: '11.093.223/0001-67')
      subsidiary2 = create(:subsidiary, cnpj: '71.158.643/0001-06')
      ...
      create(:car, license_plate: 'DCF4356', color: 'Preto',
                   car_model: car_model, subsidiary: subsidiary1, status: :available)
      create(:car, license_plate: 'FDSE1234', color: 'Preto',
                   car_model: car_model, subsidiary: subsidiary2, status: :rented)
